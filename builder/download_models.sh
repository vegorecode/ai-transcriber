...
# ===============================
# Download Faster Whisper Model (Russian)
# ===============================
faster_whisper_model_dir="${MODELS_DIR}/faster-whisper-large-v3-russian"
mkdir -p "$faster_whisper_model_dir"

download "https://huggingface.co/bzikst/faster-whisper-large-v3-russian/resolve/main/config.json"              "$faster_whisper_model_dir/config.json"
download "https://huggingface.co/bzikst/faster-whisper-large-v3-russian/resolve/main/model.bin"               "$faster_whisper_model_dir/model.bin"
download "https://huggingface.co/bzikst/faster-whisper-large-v3-russian/resolve/main/preprocessor_config.json" "$faster_whisper_model_dir/preprocessor_config.json"
download "https://huggingface.co/bzikst/faster-whisper-large-v3-russian/resolve/main/tokenizer.json"          "$faster_whisper_model_dir/tokenizer.json"
download "https://huggingface.co/bzikst/faster-whisper-large-v3-russian/resolve/main/vocabulary.json"         "$faster_whisper_model_dir/vocabulary.json"

echo "Faster Whisper (RU) model downloaded."

# ===================================
# VAD
# ===================================
# Отдельная закачка VAD больше не требуется — веса пакуются в whisperx.
